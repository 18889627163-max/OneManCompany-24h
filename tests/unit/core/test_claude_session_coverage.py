...
def _isolate_project_storage(tmp_path, monkeypatch):
    """Prevent daemon trace tests from appending to formal project logs."""
    import onemancompany.core.claude_session as cs_mod
    import onemancompany.core.project_archive as project_archive

    projects_dir = tmp_path / "projects"
    projects_dir.mkdir()
    monkeypatch.setattr(cs_mod, "PROJECTS_DIR", projects_dir)
    monkeypatch.setattr(project_archive, "PROJECTS_DIR", projects_dir)
