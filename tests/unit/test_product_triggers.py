...
def _isolate(tmp_path, monkeypatch):
    from onemancompany.core import project_archive

    monkeypatch.setattr(prod, "PRODUCTS_DIR", tmp_path / "products")
    monkeypatch.setattr(project_archive, "PROJECTS_DIR", tmp_path / "projects")
