...
def _register_all_internal_tools() -> None:
    ...
    # Long-term memory tools — namespace and verification are enforced by the
    # MemoryService; agents can only search permitted memory and propose
    # candidates, never approve or mutate formal TaskTree state.
    from onemancompany.agents.memory_tools import MEMORY_TOOLS as _memory_tools
